...
Текущая web surface после Iteration 13.4:
...
В текущем состоянии после Iteration 13.4 BeeUI отвечает за:
...
Текущий статус после Iteration 13.4:
...
Текущий contract v0 после Iteration 13.4:
...
После Iteration 13.4 BeeUI вызывает adapter через embedded mount/app factory layer
